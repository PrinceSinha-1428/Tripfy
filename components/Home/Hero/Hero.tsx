    ...
    <div className='relative w-full h-[120vh] sm:h-[100vh]  '>
        ...
        <div className='absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
            <div className='flex items-center justify-center flex-col w-full h-full'>
                ...
                {/* search box  */}
                <Searchbox/>
               <Link className='rounded-full px-14 md:px-28 -mt-4 py-2.5 overflow-hidden bg-primary group relative hover:bg-gradient-to-r hover:from-[#ff0894] hover:to-[#ff0061] text-white hover:ring-2 hover:ring-offset-2 hover:ring-[#ff0083] transition-all ease-out duration-300  ' href={"#"}>
